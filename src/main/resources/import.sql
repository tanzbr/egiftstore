...
--INSERT INTO Image (id, caption, url, priority) values(1, 'Imagem muito legal', 'url da imagem', 1);
--INSERT INTO GiftCompany (id, name, cnpj, logo_id) values(1, 'Google', '111.111.111-0001/10', 1);
